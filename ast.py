...
class CallCommand(Command):
    ...
    def __str__(self):
        return 'CallCommand(%s,%s)' % (str(self.identifier), str(self.expr_list))
...
class FunctionDeclaration(Declaration):
    ...
    def __init__(self, name, arg_list, return_type_denoter, command):
        self.name = name
        # arg_list should contain tuples: (arg_name, type-denoter)
